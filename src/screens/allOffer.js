...
const AllOffer = ({ navigation, data, props }) => {
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false}>
               ...
               <View style={{marginTop:10}}>
                <Headings
                    offerText={'OFFERS'}
                    onPressViewAll={() => navigation.navigate('')}
                />
                </View>
                <FlatList
                    data={homedata}
                ...
                <Headings
                    ...
                    onPressViewAll={() => navigation.navigate('')}
                    onPressOfferText={() => navigation.navigate('')}
                />
                            ...
                            return (
                                <TouchableOpacity style={styles.cardView} onPress={() => {
                                    ...
                                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', position: 'absolute', marginHorizontal: 5 }}>
                                        <Icon name={liked ? "heart" : "heart-o"} size={30} color="#111"
                                        />
